    ...
    companion object {
        ...
        private suspend fun populateDatabase(farmerDao: FarmerDao) {
            ...
            val farmers = listOf(
                ...
                Farmer(name = "Brown, Guy", spouse = "Shana", address = "2004 Joe Johnson Road, Catawba, NC 28609", phone = "", cellPhone = "(828) 228-8933", email = "shanabrownpoultry@gmail.com", type = "Breeder"),
                ...
                Farmer(name = "Dennis, Joe & Amy", farmName = "Dennis Family Farm", address = "548 Jim Millsaps Rd, Hiddenite, NC 28636", phone = "", cellPhone = "(828) 514-1895, (828) 635-6420", email = "amydennis@bellsouth.net", type = "Breeder"),
                ...
                Farmer(name = "Harris, Justin", farmName = "Harris Creek", address = "334 Allen Rd, Harmony, NC 28634", phone = "", cellPhone = "(704) 902-8626", email = "harriscreekfarm15@yahoo.com"),
