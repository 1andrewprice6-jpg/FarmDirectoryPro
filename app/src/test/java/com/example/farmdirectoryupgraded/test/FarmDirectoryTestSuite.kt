...
class AttendanceViewModelTest {
    ...
    fun setUp() {
        ...
        coEvery { employeeDao.getEmployeeById(any()) } returns Employee(
            id = 1, name = "Test Employee", role = "CATCHER"
        )
...
class LocationViewModelTest {
    ...
    fun testCalculateHaversineDistance() {
        ...
        val distance = viewModel.calculateHaversineDistance(
            ...
            35.7850, -81.3400 // ~0.7km away
        )
        assertTrue(distance in 0.5..0.9) // Actual distance is approximately 0.7km
    }
